# -------------------------------------------------------------------------------
# Name:        interp
# Purpose:     A Scheme Interpreter in Python
#
# Author:      Oluwayomi Longe
#
# Created:     Fri 18-Nov-2016 20:46
...
from errors import InterpSyntaxError, report_syntax_error
...
def evaluate_env(s, env, verbose=False):
    ...
    except InterpSyntaxError as err:
